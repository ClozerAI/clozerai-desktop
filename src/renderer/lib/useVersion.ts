...
export const os: 'macos' | 'windows' | 'unknown' =
...
export const osVersionRaw = (window as any).electron?.osVersion || 'unknown';
export const osVersion = formatOSVersion(os, osVersionRaw);
